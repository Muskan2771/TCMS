...
const PageNotFound = () => {
  ...
  // Animation function for the astronaut's cord
  const animateCord = () => {
  ...
  return (
    <div className="body404">
      ...
      <div className="error">
        ...
        <div className="error__description">Looks like you got lost.</div>
        {/* <Navigate to="" className="error__button error__button--active">
          Home Page
        </Navigate> */}
